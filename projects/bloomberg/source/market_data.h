...
private:
    ...
    std::vector<std::string> parse_ticker_str( std::string& str, char delimiter );
...
private:
    ...
    static const char TICK_PARAMETER_DELIMITER;

    static const std::string QUERY_STR;
    static const std::string QUERY_PARAMETER_DELIMITER;
