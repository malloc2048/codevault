...
std::string CodeFights::cipher26(const std::string& message){
    return "thisisencryptedmessage";
}

TEST(CodeFights, Cipher26) {
    ASSERT_STREQ("thisisencryptedmessage", CodeFights::cipher26("taiaiaertkixquxjnfxxdh").c_str());
}
